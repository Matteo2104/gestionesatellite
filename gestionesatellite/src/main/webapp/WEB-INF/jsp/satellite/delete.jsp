			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <form method="post" action="${pageContext.request.contextPath}/satellite/remove" class="row g-3" >
					    ...
					    <div class='card-footer'>
					        ...
					        <button type="submit" name="idSatellite" value="${delete_satellite_attr.id}" id="submit" class="btn btn-danger">Rimuovi</button>
					    </div>
